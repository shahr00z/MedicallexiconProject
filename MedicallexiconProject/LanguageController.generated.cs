...
namespace MedicallexiconProject.Controllers {
    public partial class LanguageController {
        ...
        public class ViewNames {
            public readonly string _Delete = "~/Views/Language/_Delete.cshtml";
            public readonly string Create = "~/Views/Language/Create.cshtml";
            public readonly string Index = "~/Views/Language/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_LanguageController: MedicallexiconProject.Controllers.LanguageController {
        ...
        public override System.Web.Mvc.ActionResult Create(MedicallexiconProject.ViewModel.LanguageViewModel languageViewModel) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
            callInfo.RouteValueDictionary.Add("languageViewModel", languageViewModel);
            return callInfo;
        }
